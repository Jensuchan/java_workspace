...
//		Lotto l = new Lotto();
		...
		//4. 사용자 숫자 입력받기
		while(true){ // 정답을 맞출때까지 반복하기 위해 while문 이용
			int s=0;
			int b=0;
			...
			for(int i=0; i<comNum.length; i++) { //컴퓨터 숫자 기준
				for(int j=0; j<myNum.length; j++) { //user 숫자 기준
					//스트라이크 기준 : 자리와 숫자가 일치
